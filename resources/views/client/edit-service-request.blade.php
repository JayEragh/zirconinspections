                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('service_type') is-invalid @enderror" 
                                    ...
                                    <option value="quantity_verification" {{ old('service_type', $serviceRequest->service_type) == 'quantity_verification' ? 'selected' : '' }}>
                                        Quantity Verification
                                    </option>
                                    <option value="quality_inspection" {{ old('service_type', $serviceRequest->service_type) == 'quality_inspection' ? 'selected' : '' }}>
                                        Quality Inspection
                                    </option>
                                    <option value="sampling" {{ old('service_type', $serviceRequest->service_type) == 'sampling' ? 'selected' : '' }}>
                                        Sampling
                                    </option>
                                    <option value="tank_calibration" {{ old('service_type', $serviceRequest->service_type) == 'tank_calibration' ? 'selected' : '' }}>
                                        Tank Calibration
                                    </option>
                                    <option value="other" {{ old('service_type', $serviceRequest->service_type) == 'other' ? 'selected' : '' }}>
                                        Other
                                    </option>
                                </select>
                                @error('service_type')
