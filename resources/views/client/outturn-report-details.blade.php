        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <a href="{{ route('client.outturn-reports') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left me-2"></i>
                        Back to Outturn Reports
                    </a>
                    <a href="{{ route('client.outturn-reports.pdf', $outturnReport) }}" class="btn btn-success">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('client.outturn-reports') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left me-2"></i>
                            Back to Outturn Reports
                        </a>
                    </div>
