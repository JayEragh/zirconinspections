        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <a href="{{ route('operations.outturn-reports') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left me-2"></i>
                        Back to Outturn Reports
                    </a>
                    <a href="{{ route('operations.outturn-reports.pdf', $outturnReport) }}" class="btn btn-success">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <form action="{{ route('operations.outturn-reports.approve', $outturnReport) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="btn btn-success w-100" onclick="return confirm('Are you sure you want to approve this outturn report?')">
                                <i class="fas fa-check me-2"></i>
                                Approve Report
                            </button>
                        </form>
                        <form action="{{ route('operations.outturn-reports.decline', $outturnReport) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="btn btn-danger w-100" onclick="return confirm('Are you sure you want to decline this outturn report and request amendment by the inspector?')">
                                <i class="fas fa-times me-2"></i>
                                Decline Report
                            </button>
                        </form>
                        @elseif($outturnReport->status === 'approved')
                        <div class="alert alert-success">
                            <i class="fas fa-check-circle me-2"></i>
                            Report Approved on {{ $outturnReport->approved_at->format('M d, Y H:i') }}
                        </div>
                        
                        <!-- Send to Client Button -->
                        @if($outturnReport->sent_to_client_at)
                            <div class="alert alert-info">
                                <i class="fas fa-paper-plane me-2"></i>
                                <strong>Sent to Client</strong><br>
                                Sent on {{ $outturnReport->sent_to_client_at->format('M d, Y H:i') }}
                            </div>
                        @else
                            <form action="{{ route('operations.outturn-reports.send-to-client', $outturnReport) }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="btn btn-primary w-100" onclick="return confirm('Send this approved outturn report notification to the client?')">
                                    <i class="fas fa-paper-plane me-2"></i>
                                    Send to Client
                                </button>
                            </form>
                        ...
                        <div class="alert alert-danger">
                            ...
                            Report Declined on {{ $outturnReport->declined_at->format('M d, Y H:i') }}
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('operations.outturn-reports') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left me-2"></i>
                            Back to Outturn Reports
                        </a>
                    </div>
